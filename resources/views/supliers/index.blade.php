...
<div class="middle-content container-xxl p-0">
                    ...
                    <div class="page-meta">
                        ...
                        <a href="{{url('/supliers/create')}}" class="btn btn-xm btn-primary"  style="float: right;">Crear Proveedor</a>
                          {{-- </div> --}}
